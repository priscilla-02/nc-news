    ...
    <form className="flex flex-col items-center mt-16">
      ...
      >
              ...
              <div className="mt-2">
                <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-sky-600 sm:max-w-md">
                  <input
                    ...
                    name="comment"
                    id="comment"
                    className="w-12/12 block flex-1 border-0 bg-transparent py-14 pl-1 text-gray-900 placeholder:text-black focus:ring-0 sm:text-sm sm:leading-6"
        ...
        <div className="mt-6 flex items-center justify-center gap-x-6">
          <button
            type="button"
            className="rounded-md bg-sky-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600"
